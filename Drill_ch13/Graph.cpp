...
void Lines::draw_lines() const   //jeleznünk kell, hogy ez a Lines osztály a draw lines fgv-e
{				    //itt már az fltk könyvtárat használjuk
	if (color().visibility())  //kérjük el az alapértelmezett színt, annak nézzük a visibility tagját(0-255 lehet), 
		for (int i = 1; i < number_of_points(); i+=2)
			fl_line(point(i-1).x, point(i-1).y, point(i).x, point(i).y);
} //megyünk az elsőtől a number_of_points-ig, kettesével megyünk, hívjuk az fl_line-t,
  //pont párokat adunk meg, így nem lehet páratlan
